const PrivacyPolicy = () => {
	return (
		<main className='p-policy grid grid--main reset-sb'>
			<section className='p-policy__container container'>
				<section className='p-policy__main txt-white'>
					<section className='p-policy__section section'>
						...
						<ul>
							<li>By email: bingocompanionapp@gmail.com</li>
						</ul>
					</section>
					<section className='p-policy__section p-policy__section--attribution section'>
						<h1>attribution</h1>
						<p>
							<span>
								“<strong>lottery</strong>” icon by{' '}
								<strong>Start Up Graphic Design</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/lottery'>
								{' '}
						...
						<p>
							<span>
								“<strong>User</strong>” icon by <strong>Reza Nur</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/user'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
						...
						<p>
							<span>
								“<strong>Mail</strong>” icon by <strong>Chintuza</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/mail'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
						...
						<p>
							<span>
								“<strong>config</strong>” icon by <strong>Astatine Lab</strong>{' '}
								from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/config'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
						...
						<p>
							<span>
								“<strong>entertainment</strong>” icon by{' '}
								<strong>nareerat jaikaew</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/entertainment'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
						...
						<p>
							<span>
								“<strong>sun</strong>” icon by <strong>Lil Squid</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/sun'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
						...
						<p>
							<span>
								“<strong>Moon</strong>” icon by <strong>clawa</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/moon'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
						...
						<p>
							<span>
								“<strong>lock locked</strong>” icon by{' '}
								<strong>White Spaces Inc.</strong> from
							</span>
							<a href='https://thenounproject.com/browse/icons/term/lock'>
								{' '}
								<span>Noun Project</span>
							</a>
							<span>.</span>
